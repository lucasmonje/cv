...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_conversionId":"875459096",
      "vtp_conversionLabel":"CrGBCLu7vHIQmOS5oQM",
      "vtp_url":["macro",79],
      ...
      "once_per_event":true,
      "vtp_orderId":["macro",10],
      "vtp_conversionId":"936934836",
      "vtp_conversionLabel":"MW8nCMfhwGUQtPvhvgM",
      "vtp_url":["macro",79],
      "vtp_enableReadGaCookie":false,
      "tag_id":50
    },{
  ...
  "rules":[
    ...
    [["if",12],["add",4]],
    [["if",13],["add",5,12,19]],
    [["if",0,15],["add",6],["block",9]],
    [["if",17],["add",10]],
    [["if",19,20],["unless",18],["add",11]],
    [["if",21],["add",13]],
    [["if",22],["add",14]],
    [["if",0,23],["add",16]],
    [["if",24],["add",17,18,21,29,30]],
    [["if",26,27],["add",20]],
    [["if",28],["add",22]],
    [["if",0,25],["add",23]],
    [["if",0,29],["add",23]],
    [["if",0,30],["add",23]],
    [["if",0,31],["add",23]],
    [["if",15,24],["add",24],["block",30]],
    [["if",24,25],["add",25],["block",17]],
    [["if",0],["unless",32],["add",26]],
    [["if",33],["add",27]],
    [["if",34],["add",28]],
    [["if",6],["unless",32],["add",31]],
    [["if",24,26],["unless",32],["add",32]],
    [["if",35],["unless",32],["add",33,41]],
    [["if",36],["add",33]],
    [["if",24,37],["add",37,38,40]],
    [["if",27,38],["add",39]],
    [["if",24,39],["add",40]],
    [["if",24,26],["add",42],["block",30]],
    [["if",13,14],["block",5,12]],
    [["if",0,14,15],["block",6]],
    [["if",0,14],["block",7,8,9,26]],
    [["if",0,16],["block",9]],
    [["if",6,14],["block",31]],
    [["if",14,24,26],["block",32]],
    [["if",14,35],["block",33]]]
},
"runtime":[
[],[]
...
var gc={},hc=null;gc.m="GTM-TDX8NDH";var ic=null,jc="//www.googletagmanager.com/a?id="+gc.m+"&cv=79",kc={},lc={};var mc=function(){},nc=function(a){return"function"==typeof a},oc=function(a){return"string"==ta(a)},pc=function(a){return"number"==ta(a)&&!isNaN(a)},qc=function(a){return Math.round(Number(a))||0},rc=function(a){return"false"==String(a).toLowerCase()?!1:!!a},sc=function(a){var b=[];if(oa(a))for(var c=0;c<a.length;c++)b.push(String(a[c]));return b},tc=function(a){return a?a.replace(/^\s+|\s+$/g,""):""},uc=function(a,b){if(!pc(a)||!pc(b)||a>b)a=0,b=2147483647;return Math.floor(Math.random()*(b-a+1)+
